...
Example
Input: Enter the no of terms : 4 Enter X11: 2 Enter X21: 3 Enter Y1: 4 Enter X12: 4 Enter X22: 2 Enter Y2: 5 Enter X13: 3 Enter X23: 4 Enter Y3: 6 Enter X14: 5 Enter X24: 3 Enter Y4: 7 Enter the x1 : 3 Enter the x2 : 2

makefile Copy code

Output:
Gradient B1 : 0.8 Gradient B2 : 0.2 Bias B0 : 2.0 Final Regression Equation : y = 2.0 + 0.8x1 + 0.2x2 Predicted Value of y at 3.0 and 2.0 is : 4.8000
Key Takeaways
